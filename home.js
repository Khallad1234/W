...
window.addEventListener("load", function () {
    ...
    heroDesc2.innerHTML= "طالب ثانوي ومبتلش بساعات التطوع ؟ . مع وصلة تقدر تنشأ ورشتك المتنقله الخاصة من خلال الدخول في دورات برمجية و صيانة الهواتف وغيرها ونوثق لك الشهادة التطوع ."
